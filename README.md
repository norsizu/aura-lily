...
Aura Lily 是 Aura 的单机本地部署版和轻量开源版，面向个人自托管与 ESP32-S3 硬件。它保留语音交互、角色状态、场景、日程和可配置网关等核心体验，同时去掉完整 Aura 服务中的私有生产服务与部分高级能力，方便在自己的电脑、NAS 或服务器上运行。完整 Aura 产品不计划在本仓库开源。
