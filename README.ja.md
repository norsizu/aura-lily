...
Aura Lily は、個人のセルフホストと ESP32-S3 ハードウェア向けの、独立したオープンソースのデスクトップ音声コンパニオンプロジェクトです。音声会話、キャラクターの状態、シーン、予定、設定可能なゲートウェイをリポジトリに含み、自分で管理する PC、NAS、サーバーで動かせます。ハードウェア、UI、キャラクターリソースの二次開発の基盤にもなります。
...
[LINUX DO](https://linux.do/) へのオープンソース推進・コミュニティリンク。
