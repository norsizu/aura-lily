...
Aura Lily は、個人のセルフホストと ESP32-S3 ハードウェア向けにまとめた Aura の単体運用版・軽量オープンソース版です。音声会話、キャラクターの状態、シーン、予定、設定可能なゲートウェイという中心体験を残し、完全版 Aura に含まれる非公開の本番サービスと一部の高度な機能は含みません。完全版 Aura は本リポジトリでオープンソース公開する予定はありません。
